...
<#macro getFoStyle style>
  <#if "${FOLANG}"=="en">
    <#assign foStyles = {
        "title":"font-weight=\"bold\" font-size=\"10\" text-align=\"left\"",
  ...
  <#else>
    <#assign foStyles = {
        "title":"font-weight=\"bold\" font-size=\"10\"  text-align=\"right\""}/>
    <#list style?split(' ') as styleItem>
        <#assign foStyle = foStyles[styleItem]?default("")/>
        ${foStyle?default("")}
    </#list>
...
<#macro renderLabel text id style><#if text?has_content><fo:block <#if style?has_content><@getFoStyle "title"/></#if> <#if id?has_content> id="${id}"</#if>>${text}</fo:block></#if></#macro>
