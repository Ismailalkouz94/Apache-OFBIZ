...
under the License.
-->
<section id="widget-grid"><div class="row">
...
<div role="content">
  <p class="alert alert-info fade in">${uiLabelMap.WebtoolsDataFileMessage1}</p>
    <#if security.hasPermission("DATAFILE_MAINT", session)>
      <form method="post" action="<@ofbizUrl>viewdatafile</@ofbizUrl>">
        <table class="basic-table" cellspacing="0">
          <tr>
            <td>${uiLabelMap.WebtoolsDataDefinitionFileName}&nbsp;&nbsp;</td>
            <td><input class="form-control input-xs" name="DEFINITION_LOCATION" type="text" size="60" value="${parameters.DEFINITION_LOCATION!}" /></td>
            <td><label><span>&nbsp;&nbsp;${uiLabelMap.WebtoolsDataIsUrl}&nbsp;&nbsp;</span><input type="checkbox" name="DEFINITION_IS_URL"<#if parameters.DEFINITION_IS_URL?has_content> checked="checked"</#if> /></label></td>
          </tr>
          <tr>
            <td>${uiLabelMap.WebtoolsDataDefinitionName}&nbsp;&nbsp;</td>
            <td>
              <#if definitionNames?has_content>
                <select class="form-control input-xs name="DEFINITION_NAME">
                  <option value=""></option>
              ...
              <#else>
                <input class="form-control input-xs name="DEFINITION_NAME" type="text" size="30" value="${definitionName!}" />
              </#if>
            </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><input class="form-control input-xs name="DATAFILE_LOCATION" type="text" size="60" value="${parameters.DATAFILE_LOCATION!}" /></td>
            <td><label><span>&nbsp;&nbsp;${uiLabelMap.WebtoolsDataIsUrl}&nbsp;&nbsp;</span><input type="checkbox" id="datafile_is_url" name="DATAFILE_IS_URL"<#if parameters.DATAFILE_IS_URL?has_content> checked="checked"</#if> /></label></td>
          </tr>
          <tr>
            <td>${uiLabelMap.WebtoolsDataSaveToFile}&nbsp;&nbsp;</td>
            <td><input class="form-control input-xs name="DATAFILE_SAVE" type="text" size="60" value="${parameters.DATAFILE_SAVE!}"/></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>${uiLabelMap.WebtoolsDataSaveToXml}&nbsp;&nbsp;</td>
            <td><input class="form-control input-xs name="ENTITYXML_FILE_SAVE" type="text" size="60" value="${parameters.ENTITYXML_FILE_SAVE!}" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td ><input class="btn btn-primary1"  type="submit" value="${uiLabelMap.CommonRun}" /></td>
