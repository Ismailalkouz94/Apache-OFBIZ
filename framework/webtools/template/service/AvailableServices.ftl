...
<#if selectedServiceMap??>
  <#if showWsdl?? && showWsdl = true>
    <div class="screenlet">
      ...
      <div class="screenlet-body" align="center"   style="overflow:auto">
  ...
  <#else>
    <div class="screenlet">
      ...
      <div class="screenlet-body" style="overflow:auto">
        <table  cellspacing='0'  id="datatable_col_reorder" role="grid" aria-describedby="datatable_col_reorder_info" style="width: 100%;" width="100%" class="table table-striped table-bordered table-hover dataTable no-footer">
          <tr>
    ...
    <div class="screenlet">
      ...
      <#if selectedServiceMap.permissionGroups != 'NA'>
        <table id="datatable_col_reorder" role="grid" aria-describedby="datatable_col_reorder_info" style="width: 100%;" width="100%" class="table table-striped table-bordered table-hover dataTable no-footer" cellspacing='0'>
          <tr class="header-row">
      ...
      <#else>
        <div class="screenlet-body"  style="overflow:auto">
          <div class="alert alert-info fade in">${selectedServiceMap.permissionGroups}</div>
        </div>
      </#if>
    </div>
      ...
      <div class="screenlet">
        ...
        <#else>
          <div class="screenlet-body">
           <div class="alert alert-info fade in"> ${uiLabelMap.WebtoolsNoParametersDefined}</div>
          </div>
        </#if>
      </div>
    </#list>
...
<#elseif servicesList?? && servicesList?has_content>
  ...
  <#if serviceNamesAlphaList?? && serviceNamesAlphaList?has_content>
      <div>
        ...
        <#list serviceNamesAlphaList as alpha>
         <a class="button1 facebook" href='<@ofbizUrl>${url}?constraint=alpha@${alpha}</@ofbizUrl>'>${alpha}</a>
  ...
  <div class="screenlet">
    <div class="screenlet-body"   style="overflow:auto">
   <br/>   <p>${uiLabelMap.WebtoolsServicesListFor} ${dispatcherName?default(uiLabelMap.CommonNA)} (${servicesFoundCount} ${uiLabelMap.CommonFound})</p>
      <table   id="datatable_col_reorder" role="grid" aria-describedby="datatable_col_reorder_info" style="width: 100%;" width="100%" class="table table-striped table-bordered table-hover dataTable no-footer" cellspacing='0'>
        <tr class="header-row">
