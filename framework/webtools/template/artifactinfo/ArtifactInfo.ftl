...
<#if !artifactInfo??>
    ...
    <div>
      <form name="ArtifactInfoByName" method="post" action="<@ofbizUrl>ArtifactInfo</@ofbizUrl>" class="basic-form">
       <label> Search Names/Locations: </label>  <input type="text" class="form-control" name="name" value="${parameters.name!}" size="40"/>
        ...
        <input type="hidden" name="findType" value="search"/>
         <br/>
        <input type="submit" class="btn btn-primary1" name="submitButton" value="Find"/>
      </form>
        <br/><br/>
    </div>
    <div>
      <form name="ArtifactInfoByNameAndType" method="post" action="<@ofbizUrl>ArtifactInfo</@ofbizUrl>" class="basic-form">
        <div><label style="width: 10%;">Name: </label>  <input type="text" name="name" value="${parameters.name!}" size="40"/></div>
        <div><label style="width: 10%;">Location: </label>  <input type="text" name="location" value="${parameters.location!}" size="60"/></div>
        <div><label style="width: 10%;">Type:</label>
          <select name="type">
            <option>entity</option>
            <option>service</option>
            <option>form</option>
          ...
          <br/>
          <input type="submit" class="btn btn-primary1" name="submitButton" value="Lookup"/>
        </div>
      </form>
    </div>
