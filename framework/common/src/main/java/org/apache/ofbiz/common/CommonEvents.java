...
public class CommonEvents {
    ...
    public static String FOLANG = "en";

    public static void setFOLANGTopAppBar(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("** setFOLANGTopAppBar **");
        System.out.println(request.getSession().getAttribute("FOLANG"));
        String FOLANG = (String) request.getSession().getAttribute("FOLANG");
        CommonEvents.FOLANG = FOLANG;
    }

    public static void setFOLANG(String FOLANG) {
        System.out.println("** setFOLANG **");
        System.out.println("FOLANG " + FOLANG);
        CommonEvents.FOLANG = FOLANG;
    }

    public static String getFOLANG() {
        System.out.println("** getFOLANG **");
        System.out.println("FOLANG " + FOLANG);
        return FOLANG;
    }
    ...
    public static String setAppletFollower(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (security.hasPermission("SEND_CONTROL_APPLET", userLogin)) {
            ...
            if (follow == null) {
                follow = new LinkedHashMap<String, String>();
            }
     ...
     * locale setting should be passed as a "newLocale" request parameter.
     */
