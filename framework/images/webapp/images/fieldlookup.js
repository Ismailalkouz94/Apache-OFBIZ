...
var Lookup = function(options) {
    ...
    function _modifyContainer() {
        ...
        var ame = document.getElementById("_lookupId_button");
        var mylook = document.getElementById(_newInputBoxId).id;
        var firsta = mylook.match(/\d+/)[0] ;
	 document.getElementById("_lookupId_button").id = firsta+"_lookupId_button";
