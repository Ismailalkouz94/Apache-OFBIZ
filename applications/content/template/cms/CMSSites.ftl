  ...
  <tr>
    <td width='100%'>
      ...
      <table width='100%' border='0' cellspacing='0' cellpadding='0' class='appTitle'>
        <tr>
          <td>
            <label>Root Site ID</label>
             <input class="form-control" type="text" name="rootForumId" size="20" value="${rootForumId!}"/>

          </td>
          <td valign="middle" align="right">
            
            <a href="javascript:document.userform.submit()">Refresh</a>
          </td>
        </tr>
      </table>
      </form>
  ...
  <tr>
    <td width='100%'>
      <table width='100%' border='0' cellspacing='0' cellpadding='0' class='boxbottom'>
          ...
          <td>
            <form method="post" name="publishsite" action="<@ofbizUrl>linkContentToPubPt</@ofbizUrl>">
              <table width="100%" border="0" cellpadding="1">
                    <#assign rowCount = 0 />
                    <@showSites forumId=rootForumId /><br/>
              </table>
            </form>
          </td>
        </tr>
        <tr>
         <td ><br/>
            <a class="btn btn-primary1" href="<@ofbizUrl>addSubSite?rootForumId=${rootForumId}&amp;parentForumId=${rootForumId}</@ofbizUrl>" >Add Top Level Forum</a>
         </td >
        </tr>
...
<#if requestParameters.moderatedSiteId?has_content>
  <tr>
    <td width='100%'>
      <table border="0" width='100%' cellspacing='0' cellpadding='0' class='boxoutside'>
         <tr><td><hr /></td></tr>
         <tr><td><div class="alert alert-info no-margin">Unapproved entries for forum Id:${requestParameters.moderatedSiteId}</div></td></tr>
         <tr><td><hr /></td></tr>
...
<#if requestParameters.permRoleSiteId?has_content>
  <tr>
    <td width='100%'>
      <table border="0" width='100%' cellspacing='0' cellpadding='0' class='boxoutside'>
         <tr><td><hr /></td></tr>
         <tr><td><div class="alert alert-info no-margin">Associated roles for forum Id:${requestParameters.permRoleSiteId}</div></td></tr>
         <tr><td><hr /></td></tr>
...
<@loopSubContent contentId=forumId viewIndex=0 viewSize=9999 contentAssocTypeId="SUBSITE" returnAfterPickWhen="1==1";>
       <tr class="btn-group btn-group-justified">
         <td >
            ${indent}
            <#local plusMinus="-"/>
            ${plusMinus} ${content.contentName!}
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a class="DTTT_button DTTT_button_print" href="<@ofbizUrl>CMSSites?rootForumId=${rootForumId}&amp;moderatedSiteId=${content.contentId}</@ofbizUrl>">Moderate</a>

            <a class="DTTT_button DTTT_button_print" href="<@ofbizUrl>CMSSites?rootForumId=${rootForumId}&amp;permRoleSiteId=${content.contentId}</@ofbizUrl>">User Roles</a>

            <a class="DTTT_button DTTT_button_print" href="<@ofbizUrl>addSubSite?rootForumId=${rootForumId}&amp;parentForumId=${content.contentId}</@ofbizUrl>" >Add Child Forum</a>
  
            <a class="DTTT_button DTTT_button_print" href="<@ofbizUrl>removeSite?rootForumId=${rootForumId}&amp;contentId=${content.contentId}&amp;contentIdTo=${forumId}&amp;contentAssocTypeId=SUBSITE</@ofbizUrl>">RemoveSite</a>
         </td >
       </tr>
 ...
 <form name="mostrecent" method="post" action="<@ofbizUrl>publishResponse</@ofbizUrl>"/>
  ...
  <a class="tabButton" href="<@ofbizUrl>CMSContentEdit?contentId=${content.contentId}&amp;nodeTrailCsv=${nodeTrailCsv!}</@ofbizUrl>" >View</a>
    ...
    <#if 0 < mostRecentList?size >
        <tr>
          <td colspan="5">
            <input class="btn btn-primary1" type="submit" name="submitBtn" value="${uiLabelMap.CommonUpdate}"/>
          </td>
        </tr>
    </#if>
    ...
    <td width='100%'>
      ...
      <#assign rowCount=0/>
        ...
        <tr>
          ...
          <tr>
            <td>
            <input type="submit" class="btn btn-primary1" name="submitBtn" value="${uiLabelMap.CommonUpdate}"/>
            </td>
          </tr>
      </table>
