...
<table cellspacing="8" width="100%">
  <tr>
    ...
    <td><input class="form-control" type="text" size="20" name="contentName"/></td>
  </tr>
  <tr>
    <td><label>Site Description:</label></td>
    <td><input class="form-control" type="text" size="40" name="description"/></td>
  </tr>
  <tr>
    <td><label>Posted Msg Default Status:</label></td>
    <td>
  ...
  <tr>
    <td colspan="2"><input class="btn btn-primary1" type="submit" name="submitBtn" value="Create"/></td>
  </tr>
</table>
