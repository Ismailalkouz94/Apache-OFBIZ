...
<header>
<h2>${uiLabelMap.ProductReceiveReturn} ${uiLabelMap.CommonInto} <#if facility?has_content>"${facility.facilityName?default("Not Defined")}"</#if> [${uiLabelMap.CommonId}:${facility.facilityId!}]</h2>
</header>
<div role="content">
<div class="screenlet">
    <div class="screenlet-body">
        ...
        <#else>
          <form name="selectAllForm" method="post" action="<@ofbizUrl>ReceiveReturn</@ofbizUrl>">
            ...
            <table cellspacing="0" class="basic-table">
              <tr><td colspan="4"><div class="alert alert-info fade in">${uiLabelMap.ProductReceiveReturn}</div></td></tr>
              <tr>
                <td><label>${uiLabelMap.ProductReturnNumber}</label></td>
                <td>&nbsp;</td>
                <td width="90%">
                  <input class="form-control" type="text" name="returnId" size="20" maxlength="20" value="${requestParameters.returnId!}" />
                </td>
                <td>&nbsp;</td>
              </tr>
              <tr>
