...
<header>
<h2>${uiLabelMap.ProductSearchProducts}, ${uiLabelMap.ProductSearchFor}:</h2>
</header>
<div role="content">
<div class="screenlet">
  ...
  <div class="screenlet-body">
    ...
    <div style="display: flow-root;"><label>${uiLabelMap.CommonSortedBy}<b>:</b></label><span> ${searchSortOrderString}</span>
    <a class="btn btn-primary1" href="<@ofbizUrl>advancedsearch?SEARCH_CATEGORY_ID=${(requestParameters.SEARCH_CATEGORY_ID)!}</@ofbizUrl>" class="buttontext">${uiLabelMap.CommonRefineSearch}</a>
    </div>
    <#if !productIds?has_content>
      <div class="alert alert-info fade in">${uiLabelMap.ProductNoResultsFound}.</div>
    </#if>
