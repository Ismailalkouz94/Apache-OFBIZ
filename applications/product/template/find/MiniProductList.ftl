...
<#if productCategory??>
  ...
  <#else>
    <div class="alert alert-info alert-block">${uiLabelMap.ProductNoProductsInCategory}.</div>
  </#if>
<#else>
    <div class="alert alert-info alert-block">${uiLabelMap.ProductNoCategorySpecified}.</div>
</#if>
