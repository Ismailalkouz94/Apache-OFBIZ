...
<header>
<h2>${uiLabelMap.PageTitleEditProductPromoRules}</h2>
</header>
<div role="content">
<div class="screenlet">
  <#-- ======================= Rules ======================== -->
  ...
  <#list productPromoRules as productPromoRule>
    ...
    <#list productPromoConds as productPromoCond>
      ...
      <#else>
        <div>${uiLabelMap.ProductNoConditionCategories}</div>
                ...
                <div>
                  <form method="post" class="smart-form" action="<@ofbizUrl>createProductPromoCategory</@ofbizUrl>" name="createProductPromoCategoryConditions">
      ...
      <#else>
        <div>${uiLabelMap.ProductNoConditionProducts}</div>
                ...
                <div>
                  <form method="post" class="smart-form" action="<@ofbizUrl>createProductPromoProduct</@ofbizUrl>" name="createProductPromoProductConditions">
                    <input type="hidden" name="productPromoId" value="${productPromoId}" />
                    <input type="hidden" name="productPromoRuleId" value="${productPromoCond.productPromoRuleId}" />
                    <input type="hidden" name="productPromoActionSeqId" value="_NA_" />
                    <input type="hidden" name="productPromoCondSeqId" value="${productPromoCond.productPromoCondSeqId}" />
      ...
      <#else>
        <#assign condClass = "2">
            ...
            <tr>
              <td colspan="3">
                <form method="post" class="smart-form" action="<@ofbizUrl>createProductPromoCond</@ofbizUrl>">
                  <input type="hidden" name="productPromoId" value="${(productPromoRule.productPromoId)!}" />
                  <input type="hidden" name="productPromoRuleId" value="${(productPromoRule.productPromoRuleId)!}" />
    ...
    <#list productPromoActions as productPromoAction>
      ...
      <br />
                <div>
                  <form method="post" class="smart-form" action="<@ofbizUrl>createProductPromoCategory</@ofbizUrl>" name="createProductPromoCategoryActions">
                    <input type="hidden" name="productPromoId" value="${productPromoId}" />
                    <input type="hidden" name="productPromoRuleId" value="${productPromoAction.productPromoRuleId}" />
                    <input type="hidden" name="productPromoActionSeqId" value="${productPromoAction.productPromoActionSeqId}" />
      ...
      <#else>
        <div>${uiLabelMap.ProductNoActionProducts}</div>
                ...
                <div>
                  <form method="post" class="smart-form" action="<@ofbizUrl>createProductPromoProduct</@ofbizUrl>" name="createProductPromoProductActions">
                    <input type="hidden" name="productPromoId" value="${productPromoId}" />
                    <input type="hidden" name="productPromoRuleId" value="${productPromoAction.productPromoRuleId}" />
                    <input type="hidden" name="productPromoActionSeqId" value="${productPromoAction.productPromoActionSeqId}" />
                    <input type="hidden" name="productPromoCondSeqId" value="_NA_" />
...
<header>
<h2>${uiLabelMap.ProductAddPromoRule}</h2>
</header>
<div role="content">
<div class="screenlet">
  <div class="screenlet-body">
    <form method="post" class="smart-form" action="<@ofbizUrl>createProductPromoRule</@ofbizUrl>">
      <input type="hidden" name="productPromoId" value="${productPromoId!}" />
      <label> ${uiLabelMap.ProductName}</label> &nbsp;&nbsp;<input type="text" class="form-control" size="30" name="ruleName" />
...
<header>
<h2>${uiLabelMap.ProductPromotion} ${uiLabelMap.ProductCategories}</h2>
</header>
<div role="content">
<div class="screenlet">
  <#-- ======================= Categories ======================== -->
  ...
  <#list promoProductPromoCategories as promoProductPromoCategory>
    ...
    <div>
      ...
      <form class="smart-form" name="deleteProductPromoCategoryAction_${promoProductPromoCategory_index}" method="post" action="<@ofbizUrl>deleteProductPromoCategory</@ofbizUrl>">
    ...
    <div>
      <form class="smart-form" method="post" action="<@ofbizUrl>createProductPromoCategory</@ofbizUrl>" name="createProductPromoCategoryPromotions">
        <input type="hidden" name="productPromoId" value="${productPromoId}" />
  ...
  <#list productPromoApplEnums as productPromoApplEnum>
        ...
        <label>${uiLabelMap.CommonAnd} ${uiLabelMap.CommonGroup}</label> <input type="text" size="10" maxlength="20" name="andGroupId" value="_NA_"/>*
        <input type="submit" class="btn btn-primary1" value="${uiLabelMap.CommonAdd}" />
      </form>
    </div>
  </div>
...
<header>
<h2>${uiLabelMap.ProductPromotionProducts}</h2>
</header>
<div role="content">
<div class="screenlet">
  <#-- ======================= Products ======================== -->
  ...
  <#list promoProductPromoProducts as promoProductPromoProduct>
    ...
    <div>
     <label> ${(promoProduct.internalName)!} [${promoProductPromoProduct.productId}]
      - ${(promoApplEnumeration.get("description",locale))?default(promoProductPromoProduct.productPromoApplEnumId)}</label>
      <form class="smart-form" name="deleteProductPromoProductAction_${promoProductPromoProduct_index}" action="<@ofbizUrl>deleteProductPromoProduct</@ofbizUrl>" method="post">
    ...
    <div>
      <form class="smart-form" method="post" name="createpromoproductform" action="<@ofbizUrl>createProductPromoProduct</@ofbizUrl>">
        <input type="hidden" name="productPromoId" value="${productPromoId}" />
        <input type="hidden" name="productPromoRuleId" value="_NA_" />
        <input type="hidden" name="productPromoActionSeqId" value="_NA_" />
        <input type="hidden" name="productPromoCondSeqId" value="_NA_" />
        <label>${uiLabelMap.ProductProductId}</label>*<@htmlTemplate.lookupField formName="createpromoproductform" name="productId" id="productId" fieldFormName="LookupProduct"/>
        <select name="productPromoApplEnumId">
  <#list productPromoApplEnums as productPromoApplEnum>
          <option value="${productPromoApplEnum.enumId}">${productPromoApplEnum.get("description",locale)}</option>
  </#list>
