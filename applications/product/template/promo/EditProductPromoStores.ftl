...
<header>
<h2>${uiLabelMap.PageTitleEditProductPromoStores}</h2>
</header>
<div role="content">
    <div class="screenlet">
...
<div role="content">
    <div class="screenlet">
        <div class="screenlet-body">
            <form method="post" class="smart-form" action="<@ofbizUrl>promo_createProductStorePromoAppl</@ofbizUrl>" name="addProductPromoToCatalog">
