...
<header>
<h2>${uiLabelMap.FacilitySelectOptionsToGroupBy}</h2>
</header>
<div role="content">
<div class="screenlet">
  <form method="post" name="selectFactors" action="<@ofbizUrl>PicklistOptions</@ofbizUrl>">
    ...
    <table class="basic-table" cellspacing='0'>
      <tr>
        <td><label class="checkbox-inline"><input class="checkbox style-0" type="checkbox" name="groupByShippingMethod" value="Y" <#if "${requestParameters.groupByShippingMethod!}" == "Y">checked="checked"</#if>/><span style="width:200px">${uiLabelMap.ProductPickingDetail}</span></label></td>
        <td><label class="checkbox-inline"><input class="checkbox style-0" type="checkbox" name="groupByWarehouseArea" value="Y" <#if "${requestParameters.groupByWarehouseArea!}" == "Y">checked="checked"</#if>/><span style="width:200px">${uiLabelMap.FacilityGroupByWarehouseArea} </span></label></td>
        <td><label class="checkbox-inline"><input class="checkbox style-0" type="checkbox" name="groupByNoOfOrderItems" value="Y" <#if "${requestParameters.groupByNoOfOrderItems!}" == "Y">checked="checked"</#if>/><span style="width:300px">${uiLabelMap.FacilityGroupByNoOfOrderItems}</span> </label></td>
      </tr>
      <tr><td>&nbsp;</td></tr>
    </table>
    <div align ='right'>
      <span><label>${uiLabelMap.FacilityGroupFirst}</label></span>
      <input class="form-control" style="width:50px" type="text" size="4" name="maxNumberOfOrders" value="50"/>
      <input type="submit" value="Submit" class="btn btn-primary" align='right'/>
    </div>
  </form>
</div>
</div>
...
<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
<header>
<h2>${uiLabelMap.ProductFindOrdersToPick}</h2>
</header>
<div role="content">
  <div class="screenlet-body">
    ...
    <table cellspacing="0" class="basic-table">
      ...
      <#else>
        <tr><td colspan="4"><div class="alert alert-info fade in">${uiLabelMap.ProductNoOrdersFoundReadyToPickOrNeedStockMoves}.</div></td></tr>
      </#if>
    </table>
  </div>
</div>
...
<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
<header>
<h2>${uiLabelMap.ProductPickingDetail}</h2>
</header>
<div role="content">
  <div class="screenlet">
    <div class="screenlet-body">
