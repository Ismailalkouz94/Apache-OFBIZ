...
<header>
<h2>${uiLabelMap.ProductStockMovesNeeded}</h2>
</header>
<div role="content">
<div class="screenlet">
                ...
                <#if moveByOisgirInfoList?has_content || moveByPflInfoList?has_content>
                    ...
                    <tr>
                        <td colspan="13" align="right">
                            <a href="javascript:document.selectAllForm.submit();" class="btn btn-primary1">${uiLabelMap.ProductConfirmSelectedMoves}</a>
                        </td>
                    </tr>
                <#else>
                    <tr><td colspan="13"><div class="alert alert-info fade in">${uiLabelMap.ProductNoStockMovesNeeded}.</div></td></tr>
                </#if>
                <#assign messageCount = 0>
                <#list pflWarningMessageList! as pflWarningMessage>
                    <#assign messageCount = messageCount + 1>
                    <tr><td colspan="13"><div class="alert alert-info fade in">${messageCount}:${pflWarningMessage}.</div></td></tr>
                </#list>
            </table>
...
<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
<header>
<h2>${uiLabelMap.ProductQuickStockMove}</h2>
</header>
<div role="content">
    ...
    <div class="screenlet-body">
        <form method="post" action="<@ofbizUrl>processQuickStockMove</@ofbizUrl>" name='quickStockMove'>
            ...
            <table cellspacing="0" class="basic-table hover-bar">
                ...
                <tr>
                  <td colspan="13" align="right">
                    <a href="javascript:document.quickStockMove.submit();" class="btn btn-primary1">${uiLabelMap.ProductQuickStockMove}</a>
                  </td>
                </tr>
            </table>
        </form>
