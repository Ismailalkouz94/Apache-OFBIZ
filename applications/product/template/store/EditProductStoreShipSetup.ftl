...
under the License.
-->
<form name="addscarr" class="smart-form" method="post" action="<@ofbizUrl>prepareCreateShipMeth</@ofbizUrl>">
    <input type="hidden" name="newShipMethod" value="Y"/>
    <input type="hidden" name="productStoreId" value="${productStoreId!}"/>
    <table cellspacing="0" class="basic-table">
        <tr>
          <td width="25%"><label>${uiLabelMap.ProductCarrierShipmentMethod}</label></td>
          <td>
