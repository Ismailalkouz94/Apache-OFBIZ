...
under the License.
-->
<div style="margin-bottom: 8px;"><#if parameters.showAllFacilities??>
<a href="EditProductInventoryItems?productId=${productId}" class="btn btn-primary">${uiLabelMap.ProductShowProductFacilities}</a>
<#else>
<a href="EditProductInventoryItems?productId=${productId}&amp;showAllFacilities=Y" class="btn btn-primary">${uiLabelMap.ProductShowAllFacilities}</a>
</#if></div>
<div class="screenlet">
  <#if product??>
