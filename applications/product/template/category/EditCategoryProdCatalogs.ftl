...
<header>
<h2>${uiLabelMap.PageTitleEditCategoryProductCatalogs}</h2>
</header>
<div role="content">
  <div class="screenlet">
        <div class="screenlet-body">
            ...
            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                ...
                <td align="center">
                    <form method="post" class="smart-form" action="<@ofbizUrl>category_updateProductCategoryToProdCatalog</@ofbizUrl>" name="lineForm_update${line}">
    ...
    <div class="screenlet">
        <div class="screenlet-body">
            <table cellspacing="0" class="basic-table">
                <tr><td>
                    <form method="post" class="smart-form" action="<@ofbizUrl>category_addProductCategoryToProdCatalog</@ofbizUrl>" style="margin: 0;" name="addNewForm">
