...
<header>
<h2>${uiLabelMap.PageTitleFindInventoryEventPlan}</h2>
</header>
<div role="content">
<div class="screenlet">
              ...
              <td align='right'>
                <p>
                  <#if requestParameters.hideFields?default("N") == "Y">
                    <a href="<@ofbizUrl>FindInventoryEventPlan?hideFields=N${paramList}</@ofbizUrl>" class="btn btn-primary1">${uiLabelMap.CommonShowLookupFields}</a>
                  <#else>
                    <#if inventoryList??>
                        <a href="<@ofbizUrl>FindInventoryEventPlan?hideFields=Y${paramList}</@ofbizUrl>" class="btn btn-primary1">${uiLabelMap.CommonHideFields}</a>
                    </#if>
                  </#if>
                </p>
              </td>
          ...
          <table class="basic-table" cellspacing="0" width="100%">
            <tr>
              <td align='center' width='100%'>
                 <table class="basic-table" cellspacing="0"  width="100%">
                  <tr>
                    <td width='20%'><label>${uiLabelMap.ManufacturingProductId}</label></td>
                    <td width='5%'>&nbsp;</td>
                    <td width='100%'>
                      <span>
                  ...
                  <tr>
                    <td width='20%'><label>${uiLabelMap.CommonFromDate}</label></td>
                    <td width='5%'>&nbsp;</td>
                    <td width='100%'>
                  ...
                  <tr>
                    ...
                    <td width="5%">&nbsp;</td>
                    <td width="75%"> <a href="javascript:lookupInventory();" class="btn btn-primary1">&nbsp; ${uiLabelMap.CommonFind} &nbsp;</a></td>
                  </tr>
                </table>
              </td>
            </tr>
...
<table class="basic-table" cellspacing="0">
  <tr>
    <td width='100%'>
      ...
      <div class="alert alert-info fade in">${uiLabelMap.CommonNoElementFound}</div>
