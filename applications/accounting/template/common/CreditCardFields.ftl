...
<#if !paymentMethod?has_content>
  ...
  <tr>
    <td><label>${uiLabelMap.AccountingCompanyNameCard}<label></td>
    <td width="74%">
      <input class="form-control" type="text" size="30" maxlength="60" name="companyNameOnCard" value="${creditCard.companyNameOnCard!}"/>
    </td>
  </tr>
  <tr>
    <td><label>${uiLabelMap.AccountingPrefixCard}<label></td>
    <td width="74%">
      <select class="form-control" name="titleOnCard">
  ...
  <tr>
    <td><label>${uiLabelMap.AccountingFirstNameCard}<label></td>
    <td width="74%">
      <input  class="form-control" type="text" size="20" maxlength="60" name="firstNameOnCard" value="${(creditCard.firstNameOnCard)!}"/>
    <#if showToolTip?has_content><span class="tooltip1">${uiLabelMap.CommonRequired}</span><#else>*</#if></td>
  </tr>
  <tr>
    <td><label>${uiLabelMap.AccountingMiddleNameCard}<label></td>
    <td width="74%">
      <input class="form-control" type="text" size="15" maxlength="60" name="middleNameOnCard" value="${(creditCard.middleNameOnCard)!}"/>
    </td>
  </tr>
  <tr>
    <td><label>${uiLabelMap.AccountingLastNameCard}<label></td>
    <td width="74%">
      <input class="form-control" type="text" size="20" maxlength="60" name="lastNameOnCard" value="${(creditCard.lastNameOnCard)!}"/>
    <#if showToolTip?has_content><span class="tooltip1">${uiLabelMap.CommonRequired}</span><#else>*</#if></td>
  </tr>
  <tr>
    <td><label>${uiLabelMap.AccountingSuffixCard}<label></td>
    <td width="74%">
      <select class="form-control" name="suffixOnCard">
        <option value="">${uiLabelMap.CommonSelectOne}</option>
  ...
  <tr>
    <td><label>${uiLabelMap.AccountingCardType}<label></td>
    <td width="74%">
    ...
    <td width="74%">
        <#if creditCard?has_content>
            <#if cardNumberMinDisplay?has_content>
                ...
                <input class="form-control" type="text" class="required" size="20" maxlength="30" name="cardNumber" onfocus="javascript:this.value = '';" value="${cardNumberDisplay!}" />
            <#else>
                <input class="form-control" type="text" size="20" maxlength="30" name="cardNumber" value="${creditCard.cardNumber!}"/>
            </#if>
        <#else>
            <input class="form-control"  type="text" size="20" maxlength="30" name="cardNumber" value="${creditCard.cardNumber!}"/>
        </#if>
  ...
  <tr>
    <td><label>${uiLabelMap.AccountingExpirationDate}<label></td>
    <td width="74%">
      <#assign expMonth = "">
      <#assign expYear = "">
  ...
  <tr>
    ...
    <td width="74%">
      <input class="form-control" type="text" size="20" maxlength="30" name="description" value="${paymentMethod.description!}"/>
    </td>
  </tr>
