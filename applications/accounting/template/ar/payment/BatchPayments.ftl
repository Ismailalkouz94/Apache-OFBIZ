        ...
        <form id="paymentBatchForm" method="post" action="">
            <#if paymentList?has_content>
                ...
                <div class="align-float">
                    ...
                    <input class="btn btn-primary" id="submitButton" type="button" onclick="javascript:jQuery('#paymentBatchForm').submit();" value="${uiLabelMap.CommonRun}" disabled="disabled" />
                    ...
                    <input class="form-control" type="hidden" name="groupInOneTransaction" value="Y" />
                    <input class="form-control" type="hidden" name="paymentStatusChange" id="paymentStatusChange" value="<@ofbizUrl>massChangePaymentStatus</@ofbizUrl>" />
                    <input class="form-control" type="hidden" name="statusId" id="statusId" value="${parameters.statusId!}" />
                ...
                <div id="createPaymentBatch" style="display: none;" class="align-float">
                    ...
                    <#if finAccounts?has_content>
                        ...
                        <select class="form-control" name="finAccountId" id="finAccountId">
                    ...
                    <tr class="header-row-2">
                      ...
                      <th>
                        <label class="checkbox-inline">                        
                          <input type="checkbox" class="checkbox style-0" id="checkAllPayments" name="checkAllPayments" onchange="javascript:togglePaymentId(this);"/>
                  ...
                  <tbody>
                    ...
                    <#list paymentList as payment>
                      <tr <#if alt_row> class="alternate-row"</#if>>
                        ...
                        <td>
                          <label class="checkbox-inline"><input class="checkbox style-0" type="checkbox" id="paymentId_${payment_index}" name="paymentIds" value="${payment.paymentId}" onclick="javascript:getPaymentRunningTotal('paymentId_${payment_index}');" /><span></span></label>
                        </td>
                      </tr>
