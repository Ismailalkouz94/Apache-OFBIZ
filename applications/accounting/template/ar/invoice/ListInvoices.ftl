...
<div id="datatable_col_reorder_wrapper"
  ...
  <form name="listInvoices" id="listInvoices"  method="post" action="">
    <div>
      ...
      <input class="btn btn-primary" id="submitButton" type="button"  onclick="javascript:jQuery('#listInvoices').submit();" value="${uiLabelMap.CommonRun}" disabled="disabled" />
    ...
    <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" cellspacing="0" id="datatable_col_reorder"
aria-describedby="datatable_col_reorder_info" style="width: 100%;" width="100%">
      <thead>
