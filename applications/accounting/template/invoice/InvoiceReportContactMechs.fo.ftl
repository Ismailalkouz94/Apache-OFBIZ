...
-->
<#escape x as x?xml>
<fo:table table-layout="fixed" width="100%" space-after="0.3in"   border-bottom="2.5pt solid" border-width=".1mm" border-color="#696666">
    <fo:table-column />
    <fo:table-column />
    <fo:table-body>
<#if billingAddress?has_content>
      ...
      <fo:table-row >
        <fo:table-cell>
           <fo:block>${uiLabelMap.CommonTo}: </fo:block> </fo:table-cell>
	   <fo:table-cell>          
