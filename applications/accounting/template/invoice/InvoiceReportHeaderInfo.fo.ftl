...
<fo:table-column />
<fo:table-body >
<fo:table-row  border-bottom="2.5pt solid" border-width=".1mm" border-color="#696666"> 
  <fo:table-cell>
...
<fo:table-row>
  <fo:table-cell padding-top="5px"><fo:block>${uiLabelMap.AccountingInvoiceDateAbbr}:</fo:block></fo:table-cell>
  <fo:table-cell padding-top="5px"><fo:block>${invoiceDate!}</fo:block></fo:table-cell>
</fo:table-row>
