...
<#if '${session.getAttribute("taskName")}' == "ceo">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
                ...
                <div role="content">
                    <div  class="table-responsive">
                        <form name="activiti" method="post" action="<@ofbizUrl>completeTask</@ofbizUrl>">
                            <table width="100%">
                                <tr>                                     
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" type="text" name="dateDue" id="dateDue" value="" class="email" required="true" disabled/></td>
 ...
 $(window).load(function () {
      ...
      document.getElementById("currnetDate").value=today;
          document.getElementById("dateDue").value=today;
              document.getElementById("dateDue").disabled =true;   
...
<!--<script>
        ...
        var str ="<@ofbizUrl>PaymentDetailsReport</@ofbizUrl>?p&partyId="+document.getElementById("partyId").value+"&totalAmount=" +document.getElementById("totalAmount").value+
                 "&partyName="+document.getElementById("partyName").textContent+"&paymentId="+document.getElementById("paymentId").value+
                 "&amountDue="+document.getElementById("amountDue").value+"&paymentAmount="+document.getElementById("paymentAmount").value+
                  "&dateDue="+document.getElementById("dateDue").value           
        document.getElementById("ExportAsPDF").href=str;
