...
List glAccountsParty = select("glAccountId").from("PartyGlAccount").where("roleTypeId", "BILL_FROM_VENDOR", "glAccountTypeId", "ACCOUNTS_PAYABLE","partyId",parameters.myPartyId).cache(true).queryList() 
