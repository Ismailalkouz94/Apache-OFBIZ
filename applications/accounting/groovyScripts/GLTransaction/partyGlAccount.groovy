...
//List partyIdNotIn = select("partyId").from("PartyAcctgPreference").cache(true).queryList()

List exprList = []
//exprList.add(EntityCondition.makeCondition("partyId", EntityOperator.NOT_IN, partyIdNotIn.partyId))
