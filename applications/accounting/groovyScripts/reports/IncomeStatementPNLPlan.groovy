...
println "===================" 
println "IncomeStatementPNLForecast.groovy"

listOfRevenueForecast = null
for(i=0; i<12; i++){
    ...
    context.revenueBalanceTotalForecast = balanceTotal

    if (i == 0){
        listOfRevenueForecast =  context.revenueBalanceTotalForecast
    }
    else{
        listOfRevenueForecast = listOfRevenueForecast +","+  context.revenueBalanceTotalForecast
    }
} // end of for 
println  listOfRevenueForecast

context.listOfRevenueForecast = listOfRevenueForecast
