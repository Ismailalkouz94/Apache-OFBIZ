...
//    println "exprList "+exprList
    
    println "parameters.timePeriod "+parameters.timePeriod
    println "parameters.fromDate "+parameters.fromDate
    println "parameters.thruDate "+parameters.thruDate
    ...
    if (currentTimePeriod) {
        ...
        while (customTimePeriodEndDate <= currentTimePeriod.thruDate) {
            ...
            [customTimePeriodStartDate : customTimePeriodStartDate, customTimePeriodEndDate : customTimePeriodEndDate, organizationPartyId : parameters.get('ApplicationDecorator|organizationPartyId'), glAccountId : parameters.glAccountId, isPosted : isPosted, userLogin : userLogin ,partyId : parameters.partyId])
