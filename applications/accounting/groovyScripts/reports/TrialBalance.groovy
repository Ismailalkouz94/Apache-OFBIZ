...
if (parameters.customTimePeriodId) {
    ...
    accountBalance.accountName = "Totals"
    accountBalance.postedDebits = postedDebitsTotal
    accountBalance.postedCredits = postedCreditsTotal
    accountBalance.endingBalance = postedDebitsTotal - postedCreditsTotal
