...
println "===================" 
println "IncomeStatementPNL2.groovy"

listOfRevenue = null
listOfIncome = null
listOfExpense = null
listOfNetIncome = null
...
for(i=0; i<12; i++){
    ...
    //println "glFiscalTypeId " +glFiscalTypeId
    ...
    balanceTotalList.add(UtilMisc.toMap("totalName", "Other Expenses", "balance", context.netIncome))

    context.balanceTotalList = balanceTotalList

    
    //println "revenueBalanceTotal i = "+ i +" " +context.revenueBalanceTotal
    //println "incomeBalanceTotal i = "+ i +" " +context.incomeBalanceTotal
    //println "expenseBalanceTotal  i = "+ i +" " +context.expenseBalanceTotal
    //println "netIncome  i = "+ i +" " + context.netIncome
    if (i == 0){
        listOfRevenue =  context.revenueBalanceTotal
        listOfIncome =  context.incomeBalanceTotal
        listOfExpense =  context.expenseBalanceTotal
        listOfNetIncome =  context.netIncome
    }
    else{
        listOfRevenue = listOfRevenue +","+  context.revenueBalanceTotal
        listOfIncome = listOfIncome +","+ context.incomeBalanceTotal
        listOfExpense = listOfExpense +","+ context.expenseBalanceTotal
        listOfNetIncome = listOfNetIncome +","+ context.netIncome
    }
} // end of for 

context.listOfRevenue = listOfRevenue
context.listOfIncome = listOfIncome
context.listOfExpense = listOfExpense
context.listOfNetIncome = listOfNetIncome
