...
<div class="btn-group two">
	<a class="btn btn-default btn-xs" href="<@ofbizUrl>${parameters._LAST_VIEW_NAME_}?period=week&startTime=${(prevMillis)!}&partyId=${(parameters.partyId)!}&fixedAssetId=${(parameters.fixedAssetId)!}&workEffortTypeId=${(parameters.workEffortTypeId)!}&calendarType=${(parameters.calendarType)!}&facilityId=${(parameters.facilityId)!}</@ofbizUrl>" class="smallSubmit"><i class="fa fa-chevron-left"></i>&nbsp;${uiLabelMap.WorkEffortPreviousWeek}</a>
	<a class="btn btn-default btn-xs" href="<@ofbizUrl>${parameters._LAST_VIEW_NAME_}?period=week&partyId=${(parameters.partyId)!}&fixedAssetId=${(parameters.fixedAssetId)!}&workEffortTypeId=${(parameters.workEffortTypeId)!}&calendarType=${(parameters.calendarType)!}&facilityId=${(parameters.facilityId)!}&hideEvents=${(parameters.hideEvents)!}</@ofbizUrl>" class="smallSubmit">${uiLabelMap.WorkEffortThisWeek}</a>
	<a class="btn btn-default btn-xs" href="<@ofbizUrl>${parameters._LAST_VIEW_NAME_}?period=week&startTime=${(nextMillis)!}&partyId=${(parameters.partyId)!}&fixedAssetId=${(parameters.fixedAssetId)!}&workEffortTypeId=${(parameters.workEffortTypeId)!}&calendarType=${(parameters.calendarType)!}&facilityId=${(parameters.facilityId)!}</@ofbizUrl>" class="smallSubmit">${uiLabelMap.WorkEffortNextWeek}&nbsp;<i class="fa fa-chevron-right"></i></a>
</div>
