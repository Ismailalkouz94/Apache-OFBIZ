...
<header>
<h2>${uiLabelMap.PageTitleAddressMatches}</h2>
</header>
<div role="content">
<div id="address-match-map" class="screenlet">
  <div class="div-button">
      <li><a class="button1 facebook" href="<@ofbizUrl>addressMatchMap</@ofbizUrl>">${uiLabelMap.PageTitleAddressMatchMap}</a></li>
  </div>
    ...
    <table class="basic-table" cellspacing="0">
      <form name="matchform" method="post" action="<@ofbizUrl>findAddressMatch?match=true</@ofbizUrl>">
        <tr>
          ...
          <td><input type="text" name="lastName" class="required" value="${parameters.lastName!}"/><span class="tooltip1">${uiLabelMap.CommonRequired}</span></td>
        </tr>
        <tr>
          <td class="label">${uiLabelMap.PartyFirstName}</td>
          <td><input type="text" name="firstName" class="required" value="${parameters.firstName!}"/><span class="tooltip1">${uiLabelMap.CommonRequired}</span></td>
        </tr>
        <tr>
          <td class="label">${uiLabelMap.CommonAddress1}</td>
          <td><input type="text" name="address1" class="required" value="${parameters.address1!}"/><span class="tooltip1">${uiLabelMap.CommonRequired}</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" name="city" class="required" value="${parameters.city!}"/><span class="tooltip1">${uiLabelMap.CommonRequired}</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" name="postalCode" class="required" value="${parameters.postalCode!}"/><span class="tooltip1">${uiLabelMap.CommonRequired}</span></td>
        </tr>
        <tr>
            <td></td>
            <td><input type="submit" class="btn btn-primary1" value="${uiLabelMap.PageTitleFindMatches}" /></td>
        </tr>
      </form>
      <#if match?has_content>
        ...
        <tr>
          <td colspan="2">
            ...
            <#else>
             <div class="alert alert-info fade in"> ${uiLabelMap.PartyNoMatch}</div>
            </#if>
          </td>
        </tr>
      </#if>
