...
<article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
      ...
      <a href="<@ofbizUrl>editeftaccount?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.AccountingCreateEftAccount}</a>
      <a href="<@ofbizUrl>editgiftcard?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.AccountingCreateGiftCard}</a>
      <a href="<@ofbizUrl>editcreditcard?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.AccountingCreateCreditCard}</a>
      <a href="<@ofbizUrl>EditBillingAccount?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.AccountingCreateBillingAccount}</a>
       <a href="<@ofbizUrl>AddCheckAccount?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.AccountingAddCheckAccount}</a>
        </#if>
<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-4" data-widget-editbutton="false">
<header>
<h2>${uiLabelMap.AccountingPaymentMethod}
</h2>
</header>
    ...
    <div class="screenlet-body">
      <#if paymentMethodValueMaps?has_content || billingAccounts?has_content>
        ...
        <#if billingAccounts?has_content>
            ...
            <tr>
              <td class="label">${uiLabelMap.AccountingBilling}</td>
              <td>
