...
import static org.apache.ofbiz.testtools.SimpleMethodTest.request;
...
public class PartyServices {
    ...
    public static Map<String, Object> createPerson(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        partyType = (String) context.get("TYPE");
        if (partyType == null) {
            partyType = "";
        }
        ...
        switch (partyType) {
            case "employee":
                if (UtilValidate.isEmpty(partyId)) {
                    try {
                        partyId = delegator.getNextSeqId("party_Emp");
            ...
            case "FM":
                if (UtilValidate.isEmpty(partyId)) {
                    try {
                        partyId = "FM" + delegator.getNextSeqId("party_FM");
...
//    
//        public static Map<String, Object> createPerson2(DispatchContext ctx, Map<String, ? extends Object> context) {
//        Map<String, Object> result = new HashMap<String, Object>();
//        Delegator delegator = ctx.getDelegator();
//        Timestamp now = UtilDateTime.nowTimestamp();
//        List<GenericValue> toBeStored = new LinkedList<GenericValue>();
...
//    
    /**
     * Sets a party status.
     * <b>security check</b>: the status change must be defined in
     * StatusValidChange.
     */
    ...
    public static Map<String, Object> findParty(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if ("Y".equals(lookupFlag)) {
            ...
            if (!"Y".equals(showAll)) {
                ...
                dynamicView.addAlias("PE", "EmplStatus");
                fieldsToSelect.add("EmplStatus");
                dynamicView.addViewLink("PT", "PE", Boolean.FALSE, ModelKeyMap.makeKeyMapList("partyId"));
        ...
        if (partyList == null) {
            partyList = new LinkedList<GenericValue>();
        }
