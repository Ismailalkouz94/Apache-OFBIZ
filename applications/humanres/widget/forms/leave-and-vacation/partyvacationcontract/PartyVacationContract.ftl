...
<div class="row">
    ...
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div  class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
            <header>
                <h2>Party Vacation Contract</h2>
            </header>
            <div role="content">

                <table id="vacationContract"></table>
                <div id="vacationContractDiv"></div>
            </div>
        </div>
    </article>
</div>
...
<script>
    <#include "component://humanres/widget/forms/leave-and-vacation/partyvacationcontract/PartyVacationContract.js"/>
</script>
