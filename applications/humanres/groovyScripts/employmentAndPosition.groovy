...
//employmentIds = []
employmentIdList = select("employmentId").from("EmplPosition").queryList()
employmentIds = EntityUtil.getFieldListFromEntityList(employmentIdList,"employmentId", true)
...
println "***** 2"
if (UtilValidate.isNotEmpty(employmentIds)){
    exprList = [EntityCondition.makeCondition("employmentId", EntityOperator.NOT_IN, employmentIds),
