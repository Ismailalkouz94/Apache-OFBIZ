...
<thead>
       ...
       <#if invoices?has_content>
         ...
         <tr>
           <td valign="top" width="29%">&nbsp;<label>${uiLabelMap.OrderInvoices}</label></td>
           <td width="1%">&nbsp;</td>
     ...
     <tr>
       <td valign="top" width="29%"><label>&nbsp;${uiLabelMap.OrderStatusHistory}</label></td>
       <td width="1%">&nbsp;</td>
       <td width="60%">
     ...
     <#if orderPaymentPreferences?has_content || billingAccount?has_content || invoices?has_content>
        <#list orderPaymentPreferences as orderPaymentPreference>
          ...
          <#if !paymentMethod?has_content>
                ...
                <#if billingAccount??>
                  ...
                  <tr>
                    <td valign="top" width="29%">
                      ...
                      <div>&nbsp;<label>${uiLabelMap.AccountingBillingAccount}</label>&nbsp;
            ...
            <#elseif paymentMethodType.paymentMethodTypeId == "FIN_ACCOUNT">
              ...
              <#if (finAccount?has_content)>
                ...
                <tr>
                  <td valign="top" width="29%">
                    <div>
                    <label>&nbsp;${uiLabelMap.AccountingFinAccount}</label>
                    ...
                    <#if gatewayResponses?has_content>
                      <div>
                        ...
                        <#list gatewayResponses as gatewayResponse>
                          ...
                          (<label>${uiLabelMap.OrderReference}</label>&nbsp;${gatewayResponse.referenceNum!}
                          <label>${uiLabelMap.OrderAvs}</label>&nbsp;${gatewayResponse.gatewayAvsResult?default("N/A")}
                          <label>${uiLabelMap.OrderScore}</label>&nbsp;${gatewayResponse.gatewayScoreResult?default("N/A")})
                ...
                <#if paymentList?has_content>
                    <tr>
                    <td valign="top" width="29%">
                      <div>&nbsp;<label>${uiLabelMap.AccountingInvoicePayments}</label></div>
                    </td>
                    <td width="1%">&nbsp;</td>
                      <td width="60%">
                        <div>
            ...
            <#else>
              <tr>
                <td valign="top" width="29%">
                  <div>&nbsp;<label>${paymentMethodType.get("description",locale)!}</label>&nbsp;
                  <#if orderPaymentPreference.maxAmount?has_content>
                  <br />${uiLabelMap.OrderPaymentMaximumAmount}: <@ofbizCurrency amount=orderPaymentPreference.maxAmount?default(0.00) isoCode=currencyUomId/>
                  </#if>
                  </div>
          ...
          <#else>
            <#if paymentMethod.paymentMethodTypeId! == "CREDIT_CARD">
              ...
              <tr>
                ...
                <td width="10%">
                  <#if (!orderHeader.statusId.equals("ORDER_COMPLETED")) && !(orderHeader.statusId.equals("ORDER_REJECTED")) && !(orderHeader.statusId.equals("ORDER_CANCELLED"))>
                   <#if orderPaymentPreference.statusId != "PAYMENT_SETTLED">
                      <a href="javascript:document.CancelOrderPaymentPreference_${orderPaymentPreference.orderPaymentPreferenceId}.submit()" class="btn btn-primary">${uiLabelMap.CommonCancel}</a>
                      <form name="CancelOrderPaymentPreference_${orderPaymentPreference.orderPaymentPreferenceId}" method="post" action="<@ofbizUrl>updateOrderPaymentPreference</@ofbizUrl>">
                        <input type="hidden" name="orderId" value="${orderId}" />
                        <input type="hidden" name="orderPaymentPreferenceId" value="${orderPaymentPreference.orderPaymentPreferenceId}" />
                        <input type="hidden" name="statusId" value="PAYMENT_CANCELLED" />
            ...
            <#elseif paymentMethod.paymentMethodTypeId! == "EFT_ACCOUNT">
              ...
              <tr>
                <td valign="top" width="29%">
                  <div>&nbsp;<label>${uiLabelMap.AccountingEFTAccount}</label>
                  <#if orderPaymentPreference.maxAmount?has_content>
                  <br />${uiLabelMap.OrderPaymentMaximumAmount}: <@ofbizCurrency amount=orderPaymentPreference.maxAmount?default(0.00) isoCode=currencyUomId/>
                  </#if>
                  </div>
            ...
            <#elseif paymentMethod.paymentMethodTypeId! == "GIFT_CARD">
              ...
              <tr>
                <td valign="top" width="29%">
                  <div>&nbsp;<label>${uiLabelMap.OrderGiftCard}</label>
                  <#if orderPaymentPreference.maxAmount?has_content>
                  <br />${uiLabelMap.OrderPaymentMaximumAmount}: <@ofbizCurrency amount=orderPaymentPreference.maxAmount?default(0.00) isoCode=currencyUomId/>
                  </#if>
                  </div>
        ...
        <#if customerPoNumber?has_content>
          <tr><td colspan="4"><hr /></td></tr>
          <tr>
            <td valign="top" width="29%"><label>${uiLabelMap.OrderPONumber}</label></td>
            <td width="1%">&nbsp;</td>
   ...
   <table class="basic-table" cellspacing='0'>
   <tr>
      <td width="29%" nowrap="nowrap"><label>${uiLabelMap.AccountingPaymentMethod}</label></td>
      <td width="1%">&nbsp;</td>
   ...
   <tr>
      <td width="29%" ><label>${uiLabelMap.AccountingAmount}</label></td>
      <td width="1%">&nbsp;</td>
      <td width="60%" nowrap="nowrap">
