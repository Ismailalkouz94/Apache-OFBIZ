...
<header>
<h2>${uiLabelMap.OrderOrderStatisticsPage}</h2>
</header>
...
<div style="font-size: 11px;    float: right;" class="label"> ${uiLabelMap.CommonToday} </div>
<div style="font-size: 11px;margin-right: 40px;float: right;" class="label">${uiLabelMap.OrderWTD} </div>
<div style="font-size: 11px;margin-right: 60px;float: right;" class="label">${uiLabelMap.OrderMTD} </div>
<div style="font-size: 11px;margin-right: 60px;float: right;" class="label">${uiLabelMap.OrderYTD} </div>
        ...
        <table class="basic-table" cellspacing='0'>
          ...
          <tr>
            ...
            <td style="width: 500px;">${uiLabelMap.OrderGrossDollarAmountsIncludesAdjustmentsAndPendingOrders}</td>
