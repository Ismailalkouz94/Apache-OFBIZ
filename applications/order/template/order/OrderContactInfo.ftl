...
<header>
<h2>&nbsp;${uiLabelMap.OrderContactInformation}</h2>
</header>
<div role="content">
<div class="screenlet">
    <div class="screenlet-body">
      <table class="basic-table" cellspacing='0'>
        <tr>
          <td valign="top" width="19%"><label>&nbsp;${uiLabelMap.CommonName}</label></td>
          <td width="1%">&nbsp;</td>
        ...
        <#list orderContactMechValueMaps as orderContactMechValueMap>
          ...
          <tr>
            <td valign="top" width="19%">
              <label style="width: 150px;">&nbsp;${contactMechPurpose.get("description",locale)}</label>
            </td>
            <td width="1%">&nbsp;</td>
            <td valign="top" width="80%">
              <#if contactMech.contactMechTypeId == "POSTAL_ADDRESS">
