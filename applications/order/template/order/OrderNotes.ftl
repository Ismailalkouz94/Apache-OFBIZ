...
<header>
<h2>&nbsp;${uiLabelMap.OrderNotes}
        <#if security.hasEntityPermission("ORDERMGR", "_NOTE", session)>
         &nbsp;[&nbsp;<a href="<@ofbizUrl>createnewnote?${paramString}</@ofbizUrl>">${uiLabelMap.OrderNotesCreateNew}</a>&nbsp;]
        </#if>
</h2>
</header>
<div role="content">
      ...
      <table class="basic-table" cellspacing='0'>
        <tr>
          <td>
            ...
            <#else>
              <div class="alert alert-info fade in">&nbsp;${uiLabelMap.OrderNoNotes}.</div>
            </#if>
          </td>
        </tr>
      </table>
