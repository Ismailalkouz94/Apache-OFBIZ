...
<header>
<h2>&nbsp;${uiLabelMap.OrderShipmentInformation}
<a href="<@ofbizUrl>orderview?orderId=${orderId}</@ofbizUrl>">${uiLabelMap.OrderShipmentInformationByOISG}</a>
</h2>
</header>
<div role="content">
<div class="screenlet">
...
<header>
<h2>&nbsp;${uiLabelMap.OrderShipmentInformation} - ${shipGroup.shipGroupSeqId}
           <a onclick="javascript:toggleScreenlet(this, 'ShipGroupScreenletBody_${shipGroup.shipGroupSeqId}', 'true', '${uiLabelMap.CommonExpand}', '${uiLabelMap.CommonCollapse}');" title="Collapse">&nbsp;</a>
           [<a target="_BLANK" href="<@ofbizUrl>shipGroups.pdf?orderId=${orderId}&amp;shipGroupSeqId=${shipGroup.shipGroupSeqId}</@ofbizUrl>">${uiLabelMap.OrderShipGroup} PDF</a>]</h2>
</header>
<div role="content">
    <div class="screenlet">
      <div class="screenlet-body" id="ShipGroupScreenletBody_${shipGroup.shipGroupSeqId}">
        ...
        <input type="hidden" name="oldContactMechId" value="${shipGroup.contactMechId!}"/>
          <table class="basic-table" cellspacing='0'>
                  <tr>
                      <td  width="15%">
                          <label>&nbsp;${uiLabelMap.OrderAddress}</label>
                      </td>
                      <td width="5">&nbsp;</td>
                      <td  width="80%">
                          <div>
                  ...
                  <#if orderHeader.orderTypeId == "SALES_ORDER">
                    <tr>
                      <td  width="15%">
                          <label>&nbsp;<b>${uiLabelMap.CommonMethod}</b></label>
                      </td>
                      <td width="5">&nbsp;</td>
                      <td  width="80%">
                          <div>
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="0">
          <#if shipGroup.supplierPartyId?has_content>
           ...
           <tr>
            ...
            <tr>
              <td  width="15%">
                <label>&nbsp;${uiLabelMap.ProductDropShipment} - ${uiLabelMap.PartySupplier}</label>
              </td>
              <td width="5">&nbsp;</td>
              <td  width="80%">
              ...
              <tr>
                <td colspan="3">
                  <table>
                    <tr>
                      <td>
                        <label>&nbsp;${uiLabelMap.OrderOnlineUPSShippingEstimates}</label>
                      </td>
                    </tr>
          ...
          <#if shipGroup.trackingNumber?has_content || orderShipmentInfoSummaryList?has_content>
            ...
            <tr>
              <td width="15%">
                <label>&nbsp;${uiLabelMap.OrderTrackingNumber}</label>
              </td>
              <td width="5">&nbsp;</td>
              <td width="80%">
          ...
          <#if shipGroup.maySplit?has_content && noShipment?default("false") != "true">
            ...
            <tr>
              <td  width="15%">
                <label style="width: 150px;">&nbsp;${uiLabelMap.OrderSplittingPreference}</label>
              </td>
              <td width="5">&nbsp;</td>
              <td  width="80%">
                <div>
          ...
          <tr>
            <td width="15%">
              <label>&nbsp;${uiLabelMap.OrderInstructions}</label>
            </td>
            <td width="5">&nbsp;</td>
          ...
          <tr>
            <td  width="15%">
              <label>&nbsp;${uiLabelMap.OrderGiftMessage}</label>
            </td>
            <td width="5">&nbsp;</td>
            <td>
           ...
           <tr>
              <td width="15%">
                <label><br/>&nbsp;${uiLabelMap.OrderShipAfterDate}</label><br/>
                <label>&nbsp;${uiLabelMap.OrderShipBeforeDate}</label><br/>
              </td>
              <td width="5">&nbsp;</td>
              <td  width="80%">
                <form name="setShipGroupDates_${shipGroup.shipGroupSeqId}" method="post" class="smart-form" action="<@ofbizUrl>updateOrderItemShipGroup</@ofbizUrl>">
                  <input type="hidden" name="orderId" value="${orderHeader.orderId}"/>
                  <input type="hidden" name="shipGroupSeqId" value="${shipGroup.shipGroupSeqId}"/>
                ...
                <@htmlTemplate.renderDateTimeField name="shipByDate" event="" action="" value="${shipGroup.shipByDate!}" className="" alert="" title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="shipByDate_${shipGroup.shipGroupSeqId}" dateType="date" shortDateInput=false timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName=""/>
                  <input type="submit" style="padding:4px" class="btn btn-primary" value="${uiLabelMap.CommonUpdate}"/>
                  </form>
              </td>
           <tr>
              <td width="15%">
                <label>&nbsp;${uiLabelMap.ProductEstimatedShipDate}</label>
              </td>
              <td width="5">&nbsp;</td>
              <td width="80%">
         ...
         <#if shipGroupShipments?has_content>
            ...
            <tr>
              <td  width="15%">
                <label>&nbsp;${uiLabelMap.FacilityShipments}</label>
              </td>
              <td width="5">&nbsp;</td>
              <td  width="80%">
