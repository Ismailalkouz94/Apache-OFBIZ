...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><h4><label>1) ${uiLabelMap.OrderSelectPartyToOrder} :</label></h4></td>
  </tr>
  <tr>
    <td width="100%">
      <table border="0" cellspacing="0" cellpadding="0" class="boxbottom">
	    ...
	    <label style="margin:0" class="radio radio-inline">
            <input type="radio" class="radiobox" id="additionalPartyType_Person" name="additionalPartyType" value="Person" onclick="<#if additionalPartyType??>javascript:document.quickAddPartyForm.additionalPartyId.value='';</#if>document.quickAddPartyForm.submit()"<#if (additionalPartyType?? && additionalPartyType == "Person")> checked="checked"</#if> />
	    <span></span></label>
           </td>
          <td>
        ...
        <tr>
          <td align="right">
	    <label style="margin:0" class="radio radio-inline">
            <input type="radio" class="radiobox" id="additionalPartyType_Group" name="additionalPartyType" value="Group" onclick="<#if additionalPartyType??>javascript:document.quickAddPartyForm.additionalPartyId.value='';</#if>document.quickAddPartyForm.submit()"<#if additionalPartyType?? && additionalPartyType == "Group"> checked="checked"</#if> />
	    <span></span></label>
          </td>
          <td>
        ...
        <tr>
          <td align="right">
	    <label style="margin:0" class="radio radio-inline">
            <input type="radio" class="radiobox" id="additionalPartyType_None" name="additionalPartyType" value="None" onclick="<#if additionalPartyType??>javascript:document.quickAddPartyForm.additionalPartyId.value='';</#if>document.quickAddPartyForm.submit()"<#if !additionalPartyType??> checked="checked"</#if> />
	    <span></span></label>
          </td>
          <td>
  ...
  <tr>
    <td>&nbsp;<label>2) ${uiLabelMap.PartyFindParty} :</label></td>
  </tr>
  ...
  <tr>
    <td width="100%">
      <table border="0" cellspacing="0" cellpadding="0" class="boxbottom">
        <tr>
          <td>
           &nbsp; <label>${uiLabelMap.CommonIdentifier} :</label>
          </td>
          <td>
  ...
  <tr>
    <td>&nbsp;<label>3) ${uiLabelMap.OrderPartySelectRoleForParty} :</label></td>
  </tr>
