                              ...
                              <thead>
                                ...
                                <#list orderTerms as orderTerm>
                                    <tr <#if orderTerm_index % 2 != 0>class="alternate-row"</#if> >
                                        ...
                                        <td align="right">
                                            <a href="<@ofbizUrl>setOrderTerm?termIndex=${orderTerm_index}&amp;createNew=Y</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonUpdate}</a>
                                            <a href="<@ofbizUrl>removeCartOrderTerm?termIndex=${orderTerm_index}</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonRemove}</a>
                                        </td>
                                    </tr>
                                </#list>
                                <tr>
                                    <td colspan="6">
                                        <a href="<@ofbizUrl>setOrderTerm?createNew=Y</@ofbizUrl>" class="btn btn-primary1">${uiLabelMap.CommonCreateNew}</a>
                                    </td>
                                </tr>
                            </table>
                        <#else>
                                ...
                                <table class="basic-table">
                                    <tr>
                                        <td width="26%" valign="top">
                                            <label>${uiLabelMap.OrderOrderTermType}</label>
                                        </td>
                                        <td width="5">&nbsp;</td>
                                        <td width="74%">
                                    ...
                                    <tr>
                                    <td width="26%" valign="top">
                                       <label> ${uiLabelMap.OrderOrderTermValue}</label>
                                    </td>
                                    <td width="5">&nbsp;</td>
                                    <td width="74%">
                                    ...
                                    <tr>
                                        <td width="26%" valign="top">
                                            <label>${uiLabelMap.OrderOrderTermDays}</label>
                                        </td>
                                        <td width="5">&nbsp;</td>
                                        <td width="74%">
                                    ...
                                    <tr>
                                        <td width="26%" valign="top">
                                            <label>${uiLabelMap.OrderOrderTextValue}</label>
                                        </td>
                                        <td width="5">&nbsp;</td>
                                        <td width="74%">
