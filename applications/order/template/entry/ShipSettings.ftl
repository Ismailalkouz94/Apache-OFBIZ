        ...
        <tr>
          <td>
           <div class="div-button">
            <li><a class="button1 facebook" href="<@ofbizUrl>setShipping?createNewShipGroup=Y</@ofbizUrl>" class="buttontext">${uiLabelMap.CommonCreateNew} ${uiLabelMap.OrderShipGroup}</a></li>
            <li><a class="button1 facebook" href="<@ofbizUrl>EditShipAddress</@ofbizUrl>" class="buttontext">${uiLabelMap.OrderCreateShippingAddress}</a></li>
           </div>
            <#list 1..cart.getShipGroupSize() as currIndex>
              <#assign shipGroupIndex = currIndex - 1>
              ...
              <table width="100%" border="0" cellpadding="1" cellspacing="0">
                <tr>
                  <td colspan="3">
                    <h3>${uiLabelMap.OrderShipGroup} ${uiLabelMap.CommonNbr} ${currIndex}</h3>
                  </td>
                </tr>
                <tr>
                  <td colspan="3">
                    <div>
                      <label>${uiLabelMap.PartySupplier}:</label>
                      ...
                      <label>${uiLabelMap.ProductReserveInventoryFromFacility}:</label>
...
<#-- select a party id to ship to instead -->
  ...
  <br />
  <form method="post" class="smart-form" action="setShipping" name="partyshipform">
    <div class="screenlet">
      ...
      <div class="screenlet-body">
        <table width="100%" border='0' cellspacing='0' cellpadding='0' class='boxbottom'>
          ...
          <tr>
            <td  nowrap="nowrap"><label>${uiLabelMap.PartyPartyId}</label>
                ...
                <input type="submit" style="padding:4px" class="btn btn-primary" value="Continue" />
            </td>
          </tr>
        </table>
      </div>
