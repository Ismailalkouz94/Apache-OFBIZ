      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>
            ...
            <form method="post" class="smart-form" action="<@ofbizUrl>additem</@ofbizUrl>" name="quickaddform" style="margin: 0;">
              <table border="0">
                <tr>
                ...
                <tr>
                  <td><label>${uiLabelMap.OrderQuantity} :</label></td>
                  <td><input type="text" size="6" name="quantity" value=""/></td>
                </tr>
                <tr>
                  <td><label>${uiLabelMap.OrderDesiredDeliveryDate} :</label></td>
                  <td>
                    <div>
                      ...
                      <input type="checkbox" class="checkbox style-0" name="useAsDefaultDesiredDeliveryDate" value="true"<#if useAsDefaultDesiredDeliveryDate??> checked="checked"</#if>/>
                       <span>${uiLabelMap.OrderUseDefaultDesiredDeliveryDate}</span>
                       </label>                 
                    </div>
                  </td>
                </tr>
                <tr>
                  <td><label>${uiLabelMap.OrderShipAfterDate} :</label></td>
                  <td>
                    <div>
                ...
                <tr>
                  <td><label style="width: 110px;">${uiLabelMap.OrderShipBeforeDate} :</label></td>
                  <td>
                    <div>
                ...
                <#if shoppingCart.getOrderType() == "PURCHASE_ORDER">
                <tr>
                  <td><label>${uiLabelMap.OrderOrderItemType} :</label></td>
                  <td>
                    <div>
                ...
                <tr>
                  <td><label>${uiLabelMap.CommonComment} :</label></td>
                  <td>
                    <div>
                      <input type="text" size="25" name="itemComment" value="${defaultComment!}" />
                      <label>
                       <label class="checkbox-inline">
                      <input type="checkbox" class="checkbox style-0" name="useAsDefaultComment" value="true" <#if useAsDefaultComment??>checked="checked"</#if> />
                       <span>${uiLabelMap.OrderUseDefaultComment}</span></label>                 
                      </label>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td></td>
                  <td><input type="submit" class="btn btn-primary1" value="${uiLabelMap.OrderAddToOrder}"/></td>
                </tr>
              </table>
            </form>
          </td>
