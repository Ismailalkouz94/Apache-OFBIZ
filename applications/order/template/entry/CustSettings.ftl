        ...
        <tr>
          <td>
            <table width="100%" border="0" cellpadding="1" cellspacing="0">
              <tr>
                <td width="26%"><label>${uiLabelMap.CommonTitle}</labe></td>
                <td width="5">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="26%"><label>${uiLabelMap.PartyFirstName}</label></td>
                <td width="5">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="26%"><label>${uiLabelMap.PartyMiddleInitial}</label></td>
                <td width="5">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="26%"><label>${uiLabelMap.PartyLastName}</label></td>
                <td width="5">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="26%"><label>${uiLabelMap.PartySuffix}</label></td>
                <td width="5">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="26%"><label>${uiLabelMap.PartyHomePhone}<br/>${uiLabelMap.OrderAllowSolicitation}</label></td>
                <td width="5">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="26%"><label>${uiLabelMap.PartyBusinessPhone}<br/>${uiLabelMap.OrderAllowSolicitation}</label></td>
                <td width="5">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="26%"><label>${uiLabelMap.PartyEmailAddress}<br/>${uiLabelMap.OrderAllowSolicitation}</label></td>
                <td width="5">&nbsp;</td>
                <td width="74%">
              ...
              <tr>
                <td width="26%"><label>${uiLabelMap.CommonUsername}</label></td>
                <td width="5">&nbsp;</td>
                <td width="74%">
