...
<div class="screenlet">
    <div class="screenlet-body">
		...
		<input type="radio" class="radiobox" name="paymentMethodTypeAndId" value="EXT_OFFLINE" <#if checkOutPaymentId?? && checkOutPaymentId == "EXT_OFFLINE">checked="checked"</#if> onchange="setCheckoutPaymentId(this.value)" onclick="setCheckoutPaymentId(this.value)"/>
		<span>${uiLabelMap.OrderPaymentOfflineCheckMoney}</span></label>
                </td>
              </tr>
	    ...
	    <label style="margin:0" class="radio radio-inline">
             <input type="radio" class="radiobox" name="paymentMethodTypeAndId" value="EXT_COD" <#if checkOutPaymentId?? && checkOutPaymentId == "EXT_COD">checked="checked"</#if> onchange="setCheckoutPaymentId(this.value)" onclick="setCheckoutPaymentId(this.value)"/>
	    <span> ${uiLabelMap.OrderCOD}</span></label>
             </td>
              </tr>
              <tr><td colspan="2"></td></tr>
              </#if>
              <tr>
                <td width='1%' nowrap="nowrap">
		<label style="margin:0" class="radio radio-inline">
                <input type="radio" class="radiobox" name="paymentMethodTypeAndId" value="CC" onchange="setCheckoutPaymentId(this.value)" onclick="setCheckoutPaymentId(this.value)"/>
		<span>${uiLabelMap.AccountingVisaMastercardAmexDiscover}</span></label>
                </td>
              </tr>
              <tr><td colspan="2"></td></tr>
              <tr>
                <td width='1%' nowrap="nowrap">
		<label style="margin:0" class="radio radio-inline">
                <input type="radio" class="radiobox" name="paymentMethodTypeAndId" value="EFT" onchange="setCheckoutPaymentId(this.value)" onclick="setCheckoutPaymentId(this.value)"/>
		<span>${uiLabelMap.AccountingAHCElectronicCheck}</span></label>
                </td>
              </tr>
            </table>
          </form>
