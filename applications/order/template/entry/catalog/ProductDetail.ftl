...
<table border="0" cellpadding="2" cellspacing="0" width="100%">
    ...
    <tr>
      <td colspan="2" align="right">
        <#if previousProductId??>
          <a href="<@ofbizUrl>product/~category_id=${categoryId!}/~product_id=${previousProductId!}</@ofbizUrl>" class="paginate-a">${uiLabelMap.CommonPrevious}</a>&nbsp;|&nbsp;
        </#if>
        ...
        <#if nextProductId??>
          &nbsp;|&nbsp;<a href="<@ofbizUrl>product/~category_id=${categoryId!}/~product_id=${nextProductId!}</@ofbizUrl>" class="paginate-a">${uiLabelMap.CommonNext}</a>
        </#if>
      </td>
    </tr>
  </#if>
  ...
  <tr>
    ...
    <td  valign="top">
      ...
      <form method="post" class="smart-form" action="<@ofbizUrl>additem<#if requestAttributes._CURRENT_VIEW_??>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>" name="addform"  style="margin: 0;">
    ...
    <div>
      <#if sessionAttributes.userLogin?has_content && sessionAttributes.userLogin.userLoginId != "anonymous">
        ...
        <form name="addToShoppingList" method="post" action="<@ofbizUrl>addItemToShoppingList<#if requestAttributes._CURRENT_VIEW_??>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>">
          ...
          <a href="javascript:addShoplistSubmit();" class="btn btn-primary">${uiLabelMap.OrderAddToShoppingList}</a>
        </form>
      <#else> <br />
