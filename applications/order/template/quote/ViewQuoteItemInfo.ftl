...
<thead>
            ...
            <tr>
                <td><label>${uiLabelMap.CommonSubtotal}</label></td>
                <td ><@ofbizCurrency amount=totalQuoteAmount isoCode=quote.currencyUomId/></td>
            </tr>
            <tr><td></td><td></td></tr>
            ...
            <tr>
                <td><label>${uiLabelMap.OrderGrandTotal}</label></td>
                <td>
