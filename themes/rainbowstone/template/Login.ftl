      ...
      <form method="post" action="<@ofbizUrl>login</@ofbizUrl>" class="form-signin" name="loginform">
        <table class="basic-table" cellspacing="0">
          <tr class="input-group"  style="margin-bottom: 3px;">     
            ...
            <td><input class="form-control" style="margin:0 !important;height: 28px !important; min-width: 250px;" type="text" placeholder="Username" name="USERNAME" value="${username}" size="20"/></td>
          </tr>
          <tr class="input-group"  style="margin-bottom: 3px;">         
            <td> <span class="input-group-addon"><i class="fa fa-unlock-alt fa-fw"></i></span></td>
            <td><input class="form-control" style="margin:0 !important;height: 28px !important;min-width: 250px;" placeholder="Password" type="password" name="PASSWORD" value="" size="20"/></td>
          </tr>
          <#if ("Y" == useMultitenant) >
              <#if !requestAttributes.userTenantId??>
                  <tr class="input-group"  style="margin-bottom: 3px;">  
                      <td><span class="input-group-addon"><i class="fa fa-copy fa-fw"></i></span></td>
                      <td><input class="form-control" placeholder="Tenant ID" style="margin:0 !important;height: 28px !important; min-width: 250px;" type="text" name="userTenantId" value="${parameters.userTenantId!}" size="20"/></td>
                  </tr>
              <#else>
                  <input type="hidden" class="form-control" placeholder="Tenant ID" style="margin:0 !important;height: 28px !important; min-width: 250px;" name="userTenantId" value="${requestAttributes.userTenantId!}"/>
              </#if>
          </#if>
          <tr>
