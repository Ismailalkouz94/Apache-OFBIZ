     ...
     <h1>   <span style="padding: 15px 0;font-size: 25px;color: #fff;font-weight: bold;"> ${uiLabelMap.CommonForgotYourPassword}? </span></h1>
        ...
        <form class="form-signin" role="form"  method="post" action="<@ofbizUrl>forgotPassword_step2</@ofbizUrl>" name="getSecurityQuestion">
          ...
          <div class="input-group margin-bottom-sm">
            ...
            <input class="form-control" type="text" size="20" name="USERNAME" value="<#if requestParameters.USERNAME?has_content>${requestParameters.USERNAME}<#elseif autoUserLogin?has_content>${autoUserLogin.userLoginId}</#if>"  placeholder="Username" required autofocus>
          </div>
          </#if>
